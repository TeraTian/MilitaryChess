<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebSocketChess.aspx.cs" Inherits="MilitaryChess.WebSocketChess" %>
...
<script language="javascript" type="text/javascript">
    ...
    ///WebSocket
    var ws = new WebSocket('ws://' + window.location.hostname + ':' + window.location.port + '/WebSocketServer.ashx');
    ...
    function sendNewPosition() {
        ...
        $.post("UpdateNewPosition.ashx", { "position": newjsonposition }, function () { ws.send("progress2");})
    }
    //重置所有界面
    function resetAll() {
